...
import com.grinstitute.quiz.databinding.StudyItemQuestionBinding

class StudyQuestionAdapter(
    private val questionList: ArrayList<Question>
) : RecyclerView.Adapter<StudyQuestionAdapter.QuestionViewHolder>() {

    inner class QuestionViewHolder(val binding: StudyItemQuestionBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionViewHolder {
        val binding = StudyItemQuestionBinding.inflate(LayoutInflater.from(parent.context), parent, false)
